...
| 존 경계 레버 (2026-08-11 이후) | `(0.5−0.2)·32.5` | **9.75** px — 차체 한가운데 |
| 존 폭 (px) | rear / trans / spin / front | 0 / **16.25** / **16.25** / 0 |

> 위 두 줄은 2026-08-11 개편(차체를 뒤 1/2 이동 · 앞 1/2 회전 둘로만 가름, 견인은 차체 밖
> 가이드 전용)의 값이다. 그 이전의 네 토막 시절 표(`tow 최소 레버 3.0` · `spin 레버 범위
