...
> ⚠️ **설계 히스토리 — 콘텐츠 정본이 아니다.** 여기 적힌 **콘텐츠 구조**(18개조 사전식 목록 +
> 조항별 상세)는 2026-08-22 `PLAN-RULES-REDESIGN.md` 가 주제 카드로 뒤집었고, 그 카드 구성은
> 다시 2026-08-31 [`PLAN-RULES-9CARDS.md`](./PLAN-RULES-9CARDS.md)(9카드)로 대체됐다.
> **지우지 않고 남긴다** — 화면 등록·라우팅·장면 인프라의 원설계는 여전히 이 문서에만 있다.
