...
// 뒤집을 수 있다. 그래서 gap 1 · 패딩 10 으로 **1024×600(이 앱이 잡은 최악의 작은 창)에서
// 1열이 성립하도록** 맞춰 놓고, 그 성립을 boardLayout.test 가 매번 대조한다.

/** 바에 상시 서는 칸 수 — 확대·축소·초기화 · 되돌·다시 · 코트·골대·비우기 · 내보내기·속도·보기.
 *  팝오버 안(코트 6 · 보기 3)은 닫히면 DOM 에 없으므로 여기에도 §3 표적 예산에도 안 센다. */
export const FUNCTION_BAR_ITEMS = 11;
/** 구역을 가르는 선 — 줌 | 이력 | 판 | 앱. */
export const FUNCTION_BAR_DIVIDERS = 3;
