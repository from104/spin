 ...
 *    — 오른쪽 버튼/길게 누르기 → 개체 메뉴 → [빼기]/[삭제], 또는 코트에서 **트레이로 끌어 복귀**
...
/** 고른 도구의 표시. `locked` 면 **그 도구를 계속 쓰는 중**이라 링이 두 겹이 되고 핀 배지가
 *  붙는다 — 놓기 도구면 연속 배치(§6.10a), 선택 도구면 모아 고르기(§6.10b)다. 뜻이 둘인데
 ...
 *
 *  ⚠️ 고정할 수 없는 도구(선수)에는 **한 글자도 붙이지 않는다.** 처음 이 문장을 모든 켜진
