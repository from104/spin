...
const TOPICS_KO: readonly RuleTopic[] = [
    ...
    blocks: [
      ...
      },
      {
        ...
        body: [
          ...
          // 🔁 2026-08-31 복원. 등급 이름과 출전 제한은 앞선 검증에서 "정본에 없다"며 통째로
          // 잘려 나갔었다. 실제로는 **FIPFA 원문 Law 18 본문에 있었고** 정본이 "세부는 범위를
          // 넘는다"며 별도 문서로 넘겨 버린 것이었다(별도 문서로 가는 것은 그보다 아래 세칙이다).
          // 원문 확보 후 정본을 보강해(bc2e56a) 되살렸다.
          '국제 대회에 나가려면 장애 정도를 심사받습니다. 등급은 PF1과 PF2, 둘입니다.',
          'PF1은 몸의 어려움이 아주 큰 선수, PF2는 중간이거나 가벼운 선수입니다.',
          '한 팀이 한 경기에 PF2를 두 명 넘게 내보낼 수 없습니다. 그래서 코트 위에는 늘 PF1이 최소 두 명 있습니다.',
          '등급은 잘하고 못하고를 가르는 것이 아닙니다. 체력과 나이, 성별, 실력은 등급 기준이 아닙니다.',
    ...
    blocks: [
      ...
      },
      {
        ...
        body: [
          ...
          // 🔁 2026-08-31 복원. 이 문장은 같은 날 앞선 검증에서 "정본에 근거가 없다"는 이유로
          // 잘려 나갔었다 — 그런데 근거가 없던 것이 아니라 **정본이 원문을 빠뜨리고 있었다.**
          // FIPFA 원문 Law 9 마지막 절이 그대로 이 말을 한다("The ball may only be played by
          // the players' powerchairs, it cannot be moved by contact with a player's body").
          // 영어 원문을 확보해 정본을 보강한 뒤(bc2e56a) 되살렸다. 근거는 RULES-FIPFA-2025.md
          // Law 9 의 ⬆ 항목이고, Law 12 의 '고의 핸드볼'과는 별개이며 이쪽이 더 넓다.
          '손이나 발, 몸이 닿아서 공이 움직이면 안 됩니다. 우연히 닿은 것은 괜찮습니다.',
          '고의로 손을 써서 공을 다루면 반칙입니다.',
    ...
    blocks: [
      {
        ...
        body: [
          ...
          '지면이든 공중이든 같습니다.',
          // 🆕 2026-08-31. 정본 Law 9 는 아웃 조건을 **넷** 적는데 이 카드는 하나만 말하고
          // 있었다(정본 자체가 하나만 적고 있었다 — bc2e56a 에서 보강). 나머지 셋 중 둘은
          // 코트에서 실제로 일어나는 일이라 넣는다. '주심이 멈춤'은 자명해서 뺐다.
  ...
  },
  {
    ...
    blocks: [
      ...
      // 🆕 2026-09-01 — 기현님 신규 장면. 정본 Law 13 에 이 예외가 빠져 있어(같은 날 보강)
      // 앱도 말하지 못하던 규칙이다. 코너킥(Law 17)에는 이미 적혀 있었다.
      {
        kind: 'prose',
        heading: '골키퍼는 5m에서 빠집니다',
        body: [
  ...
  },
  {
    ...
    blocks: [
      ...
      // 🆕 2026-09-01 — 기현님 신규 장면. "골키퍼가 면제" 를 "그 팀이 면제" 로 읽는 오해를 막는다.
      // 면제는 **골키퍼 한 대에만** 붙고, 나머지 둘이 3m 안에서 관여하면 그것대로 2-on-1 이다.
      {
        kind: 'prose',
        heading: '면제받는 것은 골키퍼 한 명뿐입니다',
        body: [
  ...
  },
  {
    ...
    blocks: [
      ...
      // 🆕 2026-08-31. 정본 Law 12 의 **정의 절**이 통째로 빠져 있어서 이 카드가 반칙 이름만
      // 나열하고 그 이름이 무슨 뜻인지는 못 말하고 있었다. 영어 원문 확보 후 정본을 보강해
      // (bc2e56a) 넣는다. 코치에게 가장 실용적인 대목이라 램핑 장면 **앞**에 둔다 —
      // 무엇이 허용되는지를 먼저 알아야 무엇이 반칙인지가 뜻이 선다.
      {
        kind: 'prose',
        heading: '부딪혀도 되는 자리는 정해져 있습니다',
        body: [
          '태클과 정당한 몸싸움은 됩니다. 단 프런트가드끼리 맞부딪칠 때만입니다.',
          '체어의 다른 어느 부분이 닿아도 반칙입니다.',
          '램핑은 공을 가졌든 아니든 상대에게 고의로 빠르게, 또는 과한 힘으로 들이받는 것입니다. 상대가 서 있든 움직이든 같습니다.',
          '홀딩은 상대 체어의 움직임을 고의로 붙들어 막는 것입니다.',
          '클리핑은 홀딩의 한 갈래입니다. 상대의 진행을 막으려고 체어의 옆이나 뒤를 고의로 건드리는 것입니다.',
        ],
      },
