    ...
    blocks: [
      ...
      },
      {
        ...
        note: [
          ...
          '2026-09-03: 50.8cm 높이 판정을 평면 장면이 못 보여 준다고 판단되면, 순수 세로 자 한 장(바닥선·50.8cm 파선·공 원 하나, 골라인·궤적·배지 없음)을 도해로 넣는 안이 있다 — 카드당 도해 2장 상한이라 그때는 `stuck-ball` 과 바꾼다(도해 워크플로우 openQuestions).',
        ],
      },
      {
        kind: 'prose',
