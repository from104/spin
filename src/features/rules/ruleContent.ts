...
const KO_RULE_LAWS: readonly RuleLaw[] = [
  ...
  },
  {
    ...
    group: 'play',
    title: '제9조 — 인/아웃 플레이',
    // 🆕 2026-08-31 — 정본이 네 조건 중 하나만 적고 있던 것을 보강(bc2e56a)한 뒤 따라 고쳤다.
    summary: [
  ...
  },
  {
    ...
    summary: [
      ...
      // 🆕 2026-08-31 — 정본 Law 12 의 정의 절이 통째로 빠져 있던 것을 보강한 뒤 따라 넣었다.
  ...
  },
  {
    ...
    group: 'officials',
    title: '제18조 — 선수 분류',
    // 🆕 2026-08-31 — 등급 이름과 출전 제한이 **Law 18 본문에** 있다는 사실을 정본에 보강한 뒤
    // 따라 고쳤다. 그전에는 "세부는 별도 문서" 한 줄뿐이라 부록이 원문보다 좁았다.
    summary: [
