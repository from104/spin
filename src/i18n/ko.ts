...
export const ko = {
  ...
  'tutorial.team.step2.body': '눌러서 팀을 하나 만들어 보세요 — 이름·약칭을 적고, 팔레트에서 고른 색을 홈·어웨이·중립 세 벌에 배치합니다. 마음에 안 들면 카드 ⋮ 의 [삭제]로 지울 수 있습니다.',
  ...
  // 데스크톱 자동 업데이트(2026-09-16). 알림은 토스트 한 장이고 설치는 사람이 누른다.
  'update.available': '새 버전 {{version}} 이 있습니다',
  'update.install': '지금 받기',
  'update.later': '나중에',
  'update.downloading': '받는 중…',
  'update.failed': '받지 못했습니다. 잠시 뒤 다시 시도하거나 릴리스 페이지에서 직접 받으세요.',
  ...
  'team.detail.sectionBasics': '기본 정보',
  'team.detail.gkColorHint': '골키퍼는 다른 선수와 구분되는 색을 입어야 합니다.',
  'team.kits.sectionTitle': '팀 색',
  'team.kits.legend': '팀 색',
  'team.kits.paletteLabel': '팔레트',
  'team.kits.colorName': '{{n}}번 색',
  'team.kits.addColor': '색 추가',
  'team.kits.removeColor': '{{n}}번 색 지우기',
  'team.kits.kindHome': '홈',
  'team.kits.kindAway': '어웨이',
  'team.kits.kindNeutral': '중립',
  'team.kits.slotField': '필드',
  'team.kits.slotGk': 'GK',
  'team.kits.use': '사용',
  'team.kits.useLabel': '{{kind}} 킷 사용',
  'team.kits.groupLabel': '{{kind}} {{slot}} 색',
  'team.kits.optionLabel': '{{kind}} {{slot}} 색: {{n}}번 색',
  ...
  'team.print.court': '코트',
  'team.print.bench': '벤치',
  'team.print.kitsHeading': '킷',
  'team.print.colKit': '세트',
