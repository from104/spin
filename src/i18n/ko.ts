...
export const ko = {
  ...
  'help.board.item3.desc': '확대·되돌리기·PNG 내보내기가 있고, [보드 설정] 안에 코트 형태·크기·진영, 격자·골 지역 표시, 개체 이동 속도 제한, 골대 원위치, 코트 비우기가 모여 있습니다.',
  ...
  'help.editor.item5.desc': '오른쪽 기능바의 [정보](연필 아이콘)에서 유형·상황·설명·팀 이름을 고칩니다. 시연 화면의 같은 칸은 눈 아이콘이고 거기서는 읽기만 됩니다.',
  ...
  'help.present.item4.desc': '오른쪽 기능바의 [정보](눈 아이콘)가 드릴의 유형·상황·설명을 보여 줍니다. 시연 중에는 읽기만 됩니다 — 고치려면 편집 화면의 같은 칸(연필 아이콘)으로 갑니다.',
