...
export const ko = {
  ...
  'tutorial.editor.step2.body': '카드 사이와 목록 끝의 [+] 를 누르면 그 자리에 스텝이 하나 늘어납니다 — 위 스텝을 복제해 넣습니다.',
  ...
  'tutorial.present.step3.body': '화면을 꽉 채워 코트를 크게 봅니다. 그 아래 [정보](눈 아이콘)로 드릴 설명을 읽을 수 있습니다 — 시연 중에는 고칠 수 없습니다.',
  ...
  'help.editor.item5.desc': '오른쪽 기능바 맨 위의 [정보](연필 아이콘)에서 유형·상황·설명·팀 이름을 고칩니다. 시연 화면의 같은 칸은 눈 아이콘이고 거기서는 읽기만 됩니다.',
  'help.editor.item6.term': '보드 설정',
  'help.editor.item6.desc': '오른쪽 기능바의 [보드 설정]에 격자·골 지역 표시, 개체 이동 속도 제한, 골대 원위치, 그리고 [코트 비우기]가 있습니다. 비우기는 지금 스텝만 비우고 다른 스텝은 그대로이며, 되돌리기 한 번으로 전부 돌아옵니다. 코트 형태·크기는 드릴을 만들 때 정해져 바꿀 수 없습니다.',
  ...
  'help.present.item4.term': '드릴 정보',
  'help.present.item4.desc': '오른쪽 기능바 맨 위의 [정보](눈 아이콘)가 드릴의 유형·상황·설명을 보여 줍니다. 시연 중에는 읽기만 됩니다 — 고치려면 편집 화면의 같은 칸(연필 아이콘)으로 갑니다.',
  'help.present.item5.term': '나가기',
  'help.present.item5.desc': '헤더의 [편집으로]/[세션으로], Esc, 또는 좌우 스와이프로 스텝을 넘깁니다.',
