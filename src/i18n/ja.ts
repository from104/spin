...
export const ja: Record<DictKey, string> = {
  ...
  // ── ドリル編集チュートリアル 8ステップ — src/features/editor/tutorialSteps.ts ──────
  ...
  'tutorial.editor.step2.body': 'カードの間とリストの末尾にある［+］を押すと、その場所にステップが1枚増えます — 上のステップを複製して入れます。',
  ...
  'tutorial.editor.step5.body': 'これまで作ったステップを順に再生して流れを確認します。',
  ...
  'tutorial.present.step3.body': '画面いっぱいにコートを大きく表示します。その下の［情報］（目のアイコン）でドリルの説明を読めます — 実演中は編集できません。',
  ...
  'tutorial.rules.step2.body': 'カードごとに図解・シーンの数がバッジで表示されます。押して開いてみましょう。',
  ...
  'help.library.item3.desc': '種類・状況で絞り込み、更新・作成日時・名前で並べ替えます。',
  'help.library.item4.term': 'カード/リスト表示',
  'help.library.item4.desc': '画面幅に合わせて表示方法を変えます。',
  'help.library.restartButton': 'ドリル一覧ツアーをもう一度見る',

  'help.editor.item1.term': 'ステップ',
  'help.editor.item1.desc': 'ドリルは複数の場面(ステップ)の連なりです。左のサイドバーで順序を作ります。',
  'help.editor.item2.term': 'トレイ・コート',
  'help.editor.item2.desc': '道具を選んでコートに置き、移動経路を作ります。',
  'help.editor.item3.term': '再生',
  'help.editor.item3.desc': 'これまで作ったステップを順に再生して確認します。',
  'help.editor.item4.term': 'ノート',
  'help.editor.item4.desc': 'ステップごとに説明や指示を残せます。',
  'help.editor.item5.term': 'ドリル情報',
  'help.editor.item5.desc': '右の機能バー最上部の［情報］（鉛筆アイコン）で種類・状況・説明・チーム名を編集します。実演画面の同じボタンは目のアイコンで読み取り専用です。',
  'help.editor.item6.term': 'ボード設定',
  'help.editor.item6.desc': '右の機能バーの［ボード設定］に格子・ゴールエリア表示、オブジェクト移動の速度制限、ゴール位置リセット、［コートを空にする］があります。空にするのは今のステップだけで、他のステップはそのまま、元に戻すを一度押せば全部戻ります。コートの形とサイズはドリル作成時に決まります。',
  'help.editor.restartButton': 'ドリル編集ツアーをもう一度見る',

  'help.sessions.item1.term': '新しいセッション',
  'help.sessions.item1.desc': 'セッション一覧で作成し、すぐ編集を始めます。',
  'help.sessions.item2.term': '区画',
  'help.sessions.item2.desc': 'ウォームアップや本練習などの単位でセッションを分けます。',
  'help.sessions.item3.term': 'ドリル編成',
  'help.sessions.item3.desc': '区画ごとにドリルを選び、時間を設定します。',
  'help.sessions.item4.term': '配分ゲージ',
  'help.sessions.item4.desc': '目標時間と実際の編成時間を比較して表示します(強制はしません)。',
  'help.sessions.item5.term': '参加者チェック',
  'help.sessions.item5.desc': '今回のセッションに来る選手を名簿から選びます。',
  'help.sessions.restartListButton': 'セッション一覧ツアーをもう一度見る',
  'help.sessions.restartEditorButton': 'セッション編集ツアーをもう一度見る',

  'help.present.item1.term': '再生',
  'help.present.item1.desc': 'リピート・前へ・再生・次へ・速度で進行を操作します。',
  'help.present.item2.term': 'ステップ進行バー',
  'help.present.item2.desc': '今どのステップかを示し、タップすると狙ったステップへ直接飛べます。',
  'help.present.item3.term': '全画面',
  'help.present.item3.desc': '画面いっぱいにコートを大きく表示します。',
  'help.present.item4.term': 'ドリル情報',
  'help.present.item4.desc': '右の機能バー最上部の［情報］（目のアイコン）がドリルの種類・状況・説明を表示します。実演中は読み取り専用です — 編集は編集画面の同じボタン（鉛筆アイコン）から。',
  'help.present.item5.term': '終了',
  'help.present.item5.desc': 'ヘッダーの[編集へ]/[セッションへ]、Esc、または左右スワイプでステップを送れます。',
  'help.present.restartButton': '実演ツアーをもう一度見る',
  'help.rules.item1.term': 'トピックカード',
  'help.rules.item1.desc': 'カードを選ぶと、そのトピックの文章・図解・ボードシーン・比較表を1画面で見られます。',
  ...
  'help.settings.item2.term': 'アクセシビリティ',
  'help.settings.item2.desc': '音や画面の揺れを減らす設定などがあります。',
  'help.settings.item3.term': 'データ',
  'help.settings.item3.desc': '全体バックアップ(書き出し・読み込み)、Google Drive同期(任意)を管理します。',

  'help.shortcuts.editorHeading': 'ドリル編集',
  'help.shortcuts.boardHeading': 'フリー戦術ボード',
  'help.shortcuts.presentHeading': '実演',
  'help.shortcuts.toolsHeading': '道具',
