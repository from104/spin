...
export const en: Record<DictKey, string> = {
  ...
  'tutorial.editor.step2.body': 'The [+] between cards — and at the end of the list — adds a step right there by duplicating the one above it.',
  ...
  'tutorial.present.step3.body': 'Fill the screen for a bigger view of the court. Below it, Info (eye icon) shows the drill description — read-only during a session.',
  ...
  'tutorial.rules.step2.body': 'Each card shows how many diagrams and scenes it holds. Open one to read it.',
  ...
  'help.library.item3.desc': 'Filter by type or situation, and sort by recently updated, created, or title.',
  'help.library.item4.term': 'Card/list view',
  'help.library.item4.desc': 'Switch display style to fit the screen width.',
  'help.library.restartButton': 'Replay drill library tour',

  'help.editor.item1.term': 'Steps',
  'help.editor.item1.desc': 'A drill is a sequence of scenes (steps). Build the order in the left sidebar.',
  'help.editor.item2.term': 'Tray & court',
  'help.editor.item2.desc': 'Pick a tool and place it on the court, then draw its movement path.',
  'help.editor.item3.term': 'Playback',
  'help.editor.item3.desc': 'Plays back the steps made so far, in order, to check them.',
  'help.editor.item4.term': 'Note',
  'help.editor.item4.desc': 'Leave a description or instruction for each step.',
  'help.editor.item5.term': 'Drill info',
  'help.editor.item5.desc': 'Info (pencil icon), at the top of the right function bar, edits type, situation, description, and team names. The matching button in Present has an eye icon and is read-only.',
  'help.editor.item6.term': 'Board settings',
  'help.editor.item6.desc': 'Board settings in the right function bar holds the grid and goal-area toggles, the object speed limit, goal reset, and Clear court. Clearing empties only the current step — other steps are untouched, and one undo brings it all back. A drill’s court shape and size are fixed when it is created.',
  'help.editor.restartButton': 'Replay drill editor tour',

  'help.sessions.item1.term': 'New session',
  'help.sessions.item1.desc': 'Create one from the session list and start editing right away.',
  'help.sessions.item2.term': 'Phases',
  'help.sessions.item2.desc': 'Split the session into units like warm-up and main work.',
  'help.sessions.item3.term': 'Drill assignment',
  'help.sessions.item3.desc': 'Pick drills into each phase and set their time.',
  'help.sessions.item4.term': 'Allocation gauge',
  'help.sessions.item4.desc': "Compares planned time against your goal time (not enforced).",
  'help.sessions.item5.term': 'Participant check',
  'help.sessions.item5.desc': 'Pick which players are coming to this session from the roster.',
  'help.sessions.restartListButton': 'Replay session list tour',
  'help.sessions.restartEditorButton': 'Replay session editor tour',

  'help.present.item1.term': 'Playback',
  'help.present.item1.desc': 'Loop, previous, play, next, and speed controls run the presentation.',
  'help.present.item2.term': 'Step progress',
  'help.present.item2.desc': 'Shows where you are, and tap it to jump straight to any step.',
  'help.present.item3.term': 'Fullscreen',
  'help.present.item3.desc': 'Fill the screen for a bigger view of the court.',
  'help.present.item4.term': 'Drill info',
  'help.present.item4.desc': 'Info (eye icon), at the top of the right function bar, shows the drill’s type, situation, and description. It is read-only here — edit it from the matching button (pencil icon) in the editor.',
  'help.present.item5.term': 'Exit',
  'help.present.item5.desc': 'Use the header [Back to editing]/[Back to session], Esc, or a left/right swipe to move between steps.',
  'help.present.restartButton': 'Replay presentation tour',
  'help.rules.item1.term': 'Topic cards',
  'help.rules.item1.desc': 'Pick a card to see that topic’s prose, diagrams, board scenes, and comparison table in one screen.',
  ...
  'help.settings.item2.term': 'Accessibility',
  'help.settings.item2.desc': 'Settings like sound and reduced motion.',
  'help.settings.item3.term': 'Data',
  'help.settings.item3.desc': 'Full backup (export/import) and optional Google Drive sync.',

  'help.shortcuts.editorHeading': 'Drill editor',
  'help.shortcuts.boardHeading': 'Free tactics board',
  'help.shortcuts.presentHeading': 'Presentation',
  'help.shortcuts.toolsHeading': 'Tools',
