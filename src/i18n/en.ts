...
export const en: Record<DictKey, string> = {
  ...
  'editor.functionBar.save.nameSaving': 'Saving',
  'editor.functionBar.save.nameIdle': 'Save',
  ...
  'editor.functionBar.save.titleDrill': 'Drills save automatically. Press to save right now.',
