...
export const en: Record<DictKey, string> = {
  ...
  'help.editor.item5.desc': 'Info (pencil icon) in the right function bar edits type, situation, description, and team names. The matching button in Present has an eye icon and is read-only.',
  ...
  'help.present.item4.desc': 'Info (eye icon) in the right function bar shows the drill’s type, situation, and description. It is read-only here — edit it from the matching button (pencil icon) in the editor.',
