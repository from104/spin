        ...
        blocks: [
          { kind: 'p', text: 'The [Teams] screen lays out the teams you have made as cards. A card shows the team colour swatch, name, short name, player count, PF chips, and staff count.' },
          {
            ...
            items: [
              ...
              'Under [Team colours], pick up to four colours for the [Palette].',
              'Assign those colours to the [Home], [Away] and [Neutral] kits — one [Field] colour and one [GK] colour each. [Away] and [Neutral] appear once you tick [Use].',
          ...
          { kind: 'tip', tone: 'tip', text: 'The Laws require the goalkeeper to wear a colour that **stands apart from both teams and the officials.** That is why every kit assigns [Field] and [GK] separately. Edit a palette colour and every kit using it **follows along** — you only fix a colour in one place.' },
